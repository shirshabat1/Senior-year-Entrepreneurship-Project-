...
START_TRAIN = 'train\\menta\\features\\'
START_TEST = 'test\\menta\\features\\'
...
sig_train1 = np.load('train\\menta\\area_1_menta_train_2876_signals.npy', allow_pickle=True)
sig_train2 = np.load('train\\menta\\area_2_menta_train_2876_signals.npy', allow_pickle=True)
sig_train3 = np.load('train\\menta\\area_3_menta_train_2876_signals.npy', allow_pickle=True)
sig_train4 = np.load('train\\menta\\area_4_menta_train_2876_signals.npy', allow_pickle=True)

sig_test1 = np.load('test\\menta\\area_1_menta_test_616_signals.npy', allow_pickle=True)
sig_test2 = np.load('test\\menta\\area_2_menta_test_616_signals.npy', allow_pickle=True)
sig_test3 = np.load('test\\menta\\area_3_menta_test_616_signals.npy', allow_pickle=True)
sig_test4 = np.load('test\\menta\\area_4_menta_test_616_signals.npy', allow_pickle=True)

sig_valid1 = np.load('validation\\menta\\area_1_menta_validation_616_signals.npy', allow_pickle=True)
sig_valid2 = np.load('validation\\menta\\area_2_menta_validation_616_signals.npy', allow_pickle=True)
sig_valid3 = np.load('validation\\menta\\area_3_menta_validation_616_signals.npy', allow_pickle=True)
sig_valid4 = np.load('validation\\menta\\area_4_menta_validation_616_signals.npy', allow_pickle=True)
