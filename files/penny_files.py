...
START_TRAIN = 'train\\penny\\features\\'
START_TEST = 'test\\penny\\features\\'
...
AREA_4_TRAIN = '\\area_4_penny_train_1246_signals.npyy'
...
sig_train1 = np.load('train\\penny\\signals\\area_1_penny_train_1246_signals.npy', allow_pickle=True)
sig_train2 = np.load('train\\penny\\signals\\area_2_penny_train_1246_signals.npy', allow_pickle=True)
sig_train3 = np.load('train\\penny\\signals\\area_3_penny_train_1246_signals.npy', allow_pickle=True)
sig_train4 = np.load('train\\penny\\signals\\area_4_penny_train_1246_signals.npy', allow_pickle=True)

sig_test1 = np.load('test\\penny\\signals\\area_1_penny_test_267_signals.npy', allow_pickle=True)
sig_test2 = np.load('test\\penny\\signals\\area_2_penny_test_267_signals.npy', allow_pickle=True)
sig_test3 = np.load('test\\penny\\signals\\area_3_penny_test_267_signals.npy', allow_pickle=True)
sig_test4 = np.load('test\\penny\\signals\\area_4_penny_test_267_signals.npy', allow_pickle=True)

sig_valid1 = np.load('validation\\penny\\signals\\area_1_penny_validation_267_signals.npy', allow_pickle=True)
sig_valid2 = np.load('validation\\penny\\signals\\area_2_penny_validation_267_signals.npy', allow_pickle=True)
sig_valid3 = np.load('validation\\penny\\signals\\area_3_penny_validation_267_signals.npy', allow_pickle=True)
sig_valid_4 = np.load('validation\\penny\\signals\\area_4_penny_validation_267_signals.npy', allow_pickle=True)
